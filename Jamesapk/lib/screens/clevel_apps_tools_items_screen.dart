...
class CLevelAppsToolsItemsScreen extends StatefulWidget {
  const CLevelAppsToolsItemsScreen({super.key});

  @override
  State<CLevelAppsToolsItemsScreen> createState() => _CLevelAppsToolsItemsScreenState();
}

class _CLevelAppsToolsItemsScreenState extends State<CLevelAppsToolsItemsScreen> with SingleTickerProviderStateMixin {
