...
class _SalesTeamLeadTrainingLeaderboardScreenState extends State<SalesTeamLeadTrainingLeaderboardScreen> {
  ...
  Widget _progressRing(double pct) {
    return SizedBox(
      ...
      height: 46,
      child: CustomPaint(
        painter: _RingPainterStl(pct.clamp(0, 100) / 100.0),
        child: Center(
...
class _RingPainterStl extends CustomPainter {
  final double t; // 0..1
  _RingPainterStl(this.t);
  ...
  @override
  bool shouldRepaint(covariant _RingPainterStl old) => old.t != t;
}
