...
class _BranchManagerTrainingLeaderboardScreenState extends State<BranchManagerTrainingLeaderboardScreen> {
  ...
  Widget _progressRing(double pct) {
    return SizedBox(
      ...
      height: 46,
      child: CustomPaint(
        painter: _RingPainterBm(pct.clamp(0, 100) / 100.0),
        child: Center(
...
class _RingPainterBm extends CustomPainter {
  final double t; // 0..1
  _RingPainterBm(this.t);
  ...
  @override
  bool shouldRepaint(covariant _RingPainterBm old) => old.t != t;
}
