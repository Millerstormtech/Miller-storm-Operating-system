...
class CLevelUnlockLessonScreen extends StatefulWidget {
  const CLevelUnlockLessonScreen({super.key});

  @override
  State<CLevelUnlockLessonScreen> createState() => _CLevelUnlockLessonScreenState();
}

class _CLevelUnlockLessonScreenState extends State<CLevelUnlockLessonScreen> {
  ...
  Future<void> _fetchCourses() async {
    final url = Uri.parse('https://millerstorm.tech/api/courses?userId=$_managerId&userRole=c-level&list=1');
