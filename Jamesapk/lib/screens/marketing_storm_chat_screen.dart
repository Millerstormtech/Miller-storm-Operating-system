...
class MarketingStormChatScreen extends StatefulWidget {
  const MarketingStormChatScreen({Key? key}) : super(key: key);

  @override
  _MarketingStormChatScreenState createState() => _MarketingStormChatScreenState();
}

class _MarketingStormChatScreenState extends State<MarketingStormChatScreen> {
  ...
  static const _tourSeenKey = 'tour_seen_marketing_storm_chat_v1';
    ...
    try {
      ...
      if (res.statusCode == 200 || res.statusCode == 201) {
        if (data['alreadyMember'] == true) {
          await _fetchGroups(); // admin already added them — just refresh
        } else {
