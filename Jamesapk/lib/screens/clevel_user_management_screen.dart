...
class CLevelUserManagementScreen extends StatefulWidget {
  const CLevelUserManagementScreen({super.key});

  @override
  State<CLevelUserManagementScreen> createState() => _CLevelUserManagementScreenState();
}
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: const CLevelBottomNav(active: 'users'),
      ),
    );
  }
